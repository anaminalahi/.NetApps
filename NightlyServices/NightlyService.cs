...
namespace NightlyServices
{
    public partial class NightlyService : ServiceBase
    {
        ...
        private Timer NightlyTimer;

        private DBPicturesEntities DBCnx = new DBPicturesEntities();
        ...
        {
            NightlyTimer.Start();
            EventLog.WriteEntry("NightlyTimer start");
        }
        ...
        {
            NightlyTimer.Stop();
            EventLog.WriteEntry("NightlyTimer stopped");
        }
        ...
        private void RunNightlyUpload()
        {
            try
            {
                ...
                // Remplacez cette requête LINQ par une version utilisant les méthodes d'extension LINQ to Entities
                var rqList = DBCnx.PERSONNEL
                    .Join(
                        DBCnx.FILTEREDPICTURES,
                        p => p.EMPID,
                        f => f.EMPID,
                        (p, f) => new
                        {
