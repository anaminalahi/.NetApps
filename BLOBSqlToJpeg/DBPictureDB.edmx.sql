...
-- --------------------------------------------------
-- Date Created: 11/07/2025 18:32:52
...
GO
IF OBJECT_ID(N'[DBPictureDBModelStoreContainer].[PERSONNEL]', 'U') IS NOT NULL
    DROP TABLE [DBPictureDBModelStoreContainer].[PERSONNEL];
GO
